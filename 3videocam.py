...
os.system(f"ffmpeg -f v4l2 -video_size {resolution} -framerate {fps} -i /dev/video0  -f alsa -ac 1 -i hw:3 -c:v libx264 -preset ultrafast -c:a aac -to {duration} {filename}")
